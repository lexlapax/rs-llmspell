-- Example: Tools - System Integration
-- Purpose: Examples for system integration tools with security controls
-- Prerequisites: None (tools work locally with security restrictions)
-- Expected Output: System tool demonstrations with security considerations
-- Version: 0.7.0
-- Tags: tools, system, security

-- ABOUTME: Examples for system integration tools with security controls
-- ABOUTME: Using direct Tool API with proper security boundaries
