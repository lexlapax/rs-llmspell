-- Example: Tools - Media Processing
-- Purpose: Examples for media processing tools (Audio, Video, Image)
-- Prerequisites: None (tools work locally)
-- Expected Output: Media processing tool demonstrations
-- Version: 0.7.0
-- Tags: tools, media, image, audio, video

-- ABOUTME: Examples for media processing tools (Audio, Video, Image)
-- ABOUTME: Using direct Tool API for multimedia processing
