-- Example: Tools - Data Processing
-- Purpose: Examples for data processing tools (JSON, CSV, HTTP, GraphQL)
-- Prerequisites: None (most tools work locally)
-- Expected Output: Data processing tool demonstrations
-- Version: 0.7.0
-- Tags: tools, data, json, csv

-- ABOUTME: Examples for data processing tools (JSON, CSV, HTTP, GraphQL)
-- ABOUTME: Using direct Tool API for data manipulation and processing
