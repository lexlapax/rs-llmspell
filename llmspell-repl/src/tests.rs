    ...
    impl MockKernelConnection {
        fn new() -> Self {
            ...
            Self {
                ...
                session_info: Arc::new(Mutex::new(serde_json::json!({
                    "id": "test-session-123",
