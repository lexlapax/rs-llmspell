...
/// Real HNSW vector storage implementation
pub struct RealHNSWVectorStorage {
...
#[async_trait]
impl VectorStorage for RealHNSWVectorStorage {
...
#[async_trait]
impl HNSWStorage for RealHNSWVectorStorage {
...
impl Drop for RealHNSWVectorStorage {
    fn drop(&mut self) {
        ...
        if self.persistence_dir.is_some() {
            ...
            if let Ok(handle) = rt {
                ...
                handle.spawn(async move {
                    ...
                    let temp_storage = RealHNSWVectorStorage {
...
mod tests {
    ...
    #[tokio::test]
    async fn test_real_hnsw_insert_and_search() {
        let storage = RealHNSWVectorStorage::new(3, HNSWConfig::default());
    ...
    #[tokio::test]
    async fn test_real_hnsw_parallel_insertion() {
        // Test that parallel insertion works correctly
        let storage = RealHNSWVectorStorage::new(128, HNSWConfig::default());
    ...
    #[tokio::test]
    async fn test_real_hnsw_incremental_insertion() {
        // Test that incremental insertion via parallel_insert works
        let storage = RealHNSWVectorStorage::new(64, HNSWConfig::default());
    ...
    #[tokio::test]
    async fn test_real_hnsw_persistence() {
        ...
        {
            let storage =
                RealHNSWVectorStorage::from_path(&persistence_path, 3, HNSWConfig::default())
                    .await
                    .unwrap();
