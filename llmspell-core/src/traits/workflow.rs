...
impl StepResult {
    ...
    pub fn success(step_id: ComponentId, output: super::base_agent::AgentOutput, duration: Duration) -> Self {
        Self {
            step_id,
            output,
            duration,
    ...
    pub fn failure(step_id: ComponentId, error: String, duration: Duration, retry_count: u32) -> Self {
        Self {
            step_id,
...
mod tests {
    ...
    async fn test_workflow_step_management() {
        ...
        let step2 = WorkflowStep::new("step2".to_string(), ComponentId::new())
            .with_dependency(step1.id);
    ...
    async fn test_workflow_execution_planning() {
        ...
        let step2 = WorkflowStep::new("step2".to_string(), ComponentId::new())
            .with_dependency(step1.id);
        let step3 = WorkflowStep::new("step3".to_string(), ComponentId::new())
            .with_dependency(step2.id);
    ...
    async fn test_workflow_validation() {
        ...
        assert!(error_msg.contains("invalid dependency"), "Error message was: {}", error_msg);
    }
