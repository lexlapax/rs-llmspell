# 03: Extending Components

**Build tools, agents, hooks, workflows, templates, RAG pipelines, and storage backends**

**Quick Navigation**: [Tools](#part-1-tool-development) | [Agents](#part-2-agent-development) | [Hooks](#part-3-hook-development) | [Workflows](#part-4-workflow-development) | [RAG](#part-5-rag-system-extension) | [Storage](#part-6-storage-backend-extension) | [Templates](#part-7-template-creation)

---

## Overview

This guide covers **ALL** extension patterns for rs-llmspell, from simple tools to complex RAG pipelines, storage backends, and AI workflow templates. Each part builds on the previous, showing how components integrate.
...
- RAG pipeline extension (Phase 8)
- Storage backend implementation (Phase 13b.16)
- Template creation for AI workflows (Phase 12)
...
## PART 7: Template Creation (Phase 12)

### Template Architecture Overview

Templates are experimental AI workflow components combining agents, tools, RAG, and LLM providers into reusable, configurable patterns. Phase 12 introduced 10 built-in templates with production-quality patterns.

**Study**: `llmspell-templates/src/builtin/` for production patterns

### Minimum Viable Template (50 LOC)
...
#[tokio::test]
#[cfg_attr(test_category = "integration")]
#[cfg_attr(test_category = "template")]
...
✅ **Workflow Development**: Four patterns + multi-agent coordination
✅ **RAG Extension**: Pipeline builder, custom providers, HNSW tuning
✅ **Storage Backend Extension**: StorageBackend trait, hot-swappable backends
✅ **Template Creation**: AI workflow templates with production patterns

**Next Steps**:
1. Study the 60+ examples in `examples/`
2. Start with tools, progress to agents, then RAG, storage backends, templates
3. Use production patterns from existing implementations
4. Test thoroughly with proper categorization

**Extension Patterns by Complexity**:
- **Beginner**: Tools (BaseAgent + Tool trait)
- **Intermediate**: Agents (LLM integration), Hooks (cross-cutting), Templates (workflow composition)
- **Advanced**: Workflows (multi-agent), RAG (pipeline extension)
- **Expert**: Storage Backends (distributed systems, multi-tenancy)

---

*This guide consolidates extending-llmspell.md (1,581 lines) + template-creation.md (437 lines) into a comprehensive component extension reference.*
