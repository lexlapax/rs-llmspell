...
- [ ] All module files created (can be empty)
- [ ] Dependencies resolve correctly
- [ ] No clippy warnings with `cargo clippy -p llmspell-rag`
...
**Acceptance Criteria:**
- [ ] `VectorStorage` trait with scope-aware methods
- [ ] `VectorEntry` struct with StateScope field
- [ ] `HNSWStorage` trait with namespace support
- [ ] `HybridStorage` trait for multi-modal retrieval
...
- [ ] Provider extension types compile
- [ ] Integration with `ProviderManager` designed
