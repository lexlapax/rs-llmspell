...
### Task 13b.1.1: Add Linux to GitHub Actions CI Matrix
**Priority**: CRITICAL
...
**Acceptance Criteria**:
- [ ] `.github/workflows/ci.yml` includes ubuntu-latest
- [ ] Parallel matrix builds (macOS + Linux)
- [ ] Both platforms compile successfully
- [ ] CI runtime <10 minutes for matrix
...
1. Edit `.github/workflows/ci.yml`:
   ...
   runs-on: ${{ matrix.os }}
   ```
2. Add platform-specific steps (if needed)
3. Verify cargo build --workspace --all-targets on both platforms
4. Check cargo test --workspace --all-features on both platforms
5. Monitor CI runtime and optimize if needed
...
- [ ] Zero compilation errors on Linux
- [ ] Zero clippy warnings on Linux
- [ ] All 149 Phase 13 tests pass on Linux
- [ ] CI runtime acceptable (<10 min)
