...
- [ ] SessionStatus enum (Active, Suspended, Completed, Failed, Archived)
...
- [ ] FromStr implementation for SessionId
...
**Testing Requirements**:
- [ ] Unit tests for SessionId generation and parsing
...
**Definition of Done**:
- [ ] All types fully implemented with docs
...
**Testing Requirements**:
- [ ] SessionManager construction tests
- [ ] Dependency injection tests
- [ ] Thread safety tests
- [ ] Configuration validation tests

**Definition of Done**:
- [ ] SessionManager structure complete
...
**Files to Create/Update**:
- **CREATE**: `llmspell-sessions/src/session.rs` - Session implementation
...
- [ ] Session lifecycle methods (create, suspend, resume, complete)
...
**Definition of Done**:
- [ ] All session operations implemented
...
**Acceptance Criteria**:
- [ ] session:start hook integration with proper context
- [ ] session:end hook integration
- [ ] session:suspend hook integration
- [ ] session:resume hook integration
- [ ] Hook context properly populated with session data
