...
impl SessionManager {
    ...
    pub async fn suspend_session(&self, session_id: &SessionId) -> Result<()> {
        ...
        if self.config.event_config.enable_session_events {
            ...
            let suspend_event = crate::sessions::events::SessionEvent::new(
                *session_id,
    ...
    pub async fn resume_session(&self, session_id: &SessionId) -> Result<()> {
        ...
        if self.config.event_config.enable_session_events {
            ...
            let resume_event = crate::sessions::events::SessionEvent::new(
                *session_id,
    ...
    pub async fn complete_session(&self, session_id: &SessionId) -> Result<()> {
        ...
        if self.config.event_config.enable_session_events {
            ...
            let complete_event = crate::sessions::events::SessionEvent::new(
                *session_id,
    ...
    pub async fn store_artifact(
        ...
        if self.config.event_config.enable_session_events {
            ...
            let artifact_event = crate::sessions::events::SessionEvent::new(
                *session_id,
    ...
    pub async fn delete_artifact(
        ...
        if self.config.event_config.enable_session_events {
            ...
            let delete_event = crate::sessions::events::SessionEvent::new(
    ...
    pub async fn grant_artifact_permission(
        ...
        permission: crate::sessions::artifact::access::Permission,
    ) -> Result<()> {
        self.artifact_storage
            .access_control_manager()
            .grant_permission(
    ...
    pub async fn get_artifact_acl(
        ...
        requesting_session_id: &SessionId,
        artifact_id: &ArtifactId,
    ) -> Result<crate::sessions::artifact::access::AccessControlList> {
    ...
    pub async fn get_artifact_audit_log(
        ...
        requesting_session_id: &SessionId,
        artifact_id: &ArtifactId,
    ) -> Result<Vec<crate::sessions::artifact::access::AccessAuditEntry>> {
    ...
    pub async fn replay_session(
        &self,
        session_id: &SessionId,
        config: crate::sessions::replay::session_adapter::SessionReplayConfig,
    ) -> Result<crate::sessions::replay::session_adapter::SessionReplayResult> {
    ...
    pub fn get_replay_status(
        &self,
        session_id: &SessionId,
    ) -> Option<crate::sessions::replay::session_adapter::SessionReplayStatus> {
    ...
    pub fn get_all_active_replays(
        &self,
    ) -> Vec<crate::sessions::replay::session_adapter::SessionReplayStatus> {
    ...
    pub async fn get_session_replay_metadata(
        &self,
        session_id: &SessionId,
    ) -> Result<crate::sessions::replay::session_adapter::SessionReplayMetadata> {
        self.replay_engine
