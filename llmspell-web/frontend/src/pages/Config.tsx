...
export const Config = () => {
    ...
    return (
        <div className="h-full flex flex-col p-6 overflow-hidden">
            ...
            {/* Warning Banner */}
            <div className="mb-6 bg-yellow-900/20 border border-yellow-800/50 rounded-lg p-3 flex items-start gap-3">
                <AlertTriangle className="w-5 h-5 text-yellow-500 flex-shrink-0 mt-0.5" />
                <div className="text-sm text-yellow-200/80">
                    <p className="font-medium text-yellow-400">Simulation Mode</p>
                    <p>Configuration updates are currently simulated. Changes made here will be validated but not persisted to the running kernel until Phase 14 configuration persistence is finalized.</p>
                </div>
            </div>
